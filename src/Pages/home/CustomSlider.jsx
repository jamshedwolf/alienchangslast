...
function CustomSlider() {
  ...
  return (
    <div className="flex flex-col w-[100%] overflow-x-hidden justify-center items-center gap-5 mx-auto h-[70vh]">
      <p className="atomicage h p-3 font-bold  text-center  rounded-lg bg-black text-[#ECDD91]">Acc€$$ CrypTokens & Nfts</p>
      <div className="lg:max-w-[1200px] w-full">
        <Slider className="mx-auto" {...settings}>
          {sliderItems.map((item, index) => (
            <div key={index} className="h-[300px]     gap-5 relative overflow-hidden custom-card mx-20 lg:mx-5 border bg-[#03C649] rounded-[40px]">
  ...
  <div className="flex justify-center items-start flex-grow-0 flex-shrink-0 w-[155px]">
    ...
    <div className="flex flex-col justify-start items-center self-stretch flex-grow relative">
      <p className="flex-grow-0 exo flex-shrink-0 text-[12px] min-w-fit font-bold text-center text-[#ecdd91]">
        MINT NOW
      </p>
    </div>
  </div>
