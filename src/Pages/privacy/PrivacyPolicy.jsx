...
<div className="max-w-[1400px] flex-col gap-5 mx-auto flex items-center justify-center">

<p className="text-3xl ">Privacy Policy</p>
<p className="text-4xl">Aviso Legal | Legal Warning</p>
<p className="text-2xl">ACEPTACIÓN / CONDICIONES DE ACCESO Y UTILIZACIÓN</p>
<p className="">Acceder a este sitio web utiliza cookies propias y de terceros que analizan el uso del mismo con la finalidad de mejorar nuestros contenidos y su experiencia como usuario. Si continua navegando, consideramos que acepta su uso mediante la aceptación plena y sin reservas de todas y cada una de las disposiciones incluidas en este Aviso Legal, que pueden sufrir modificaciones.. Puede obtener más información o bien conocer cómo cambiar su configuración en nuestras condiciones & terminos, política de cookies y privacidad.<br/>
...
Las cookies son pequeñas cantidades de información que se almacenan en el navegador utilizado por cada Usuario en los distintos dispositivos que pueda utilizar para navegar para que el servidor recuerde cierta información que posteriormente y únicamente el servidor que la implementó leerá. Las cookies facilitan la navegación, la hacen más amigable, y no dañan el dispositivo de navegación.<br/>
...
<p className="text-2xl">Quiénes somos</p>
Texto sugerido: La dirección de nuestra web es: https://alienflow.space.

<p className="text-2xl">Comentarios</p>
...
Texto sugerido: Cuando los visitantes dejan comentarios en la web, recopilamos los datos que se muestran en el formulario de comentarios, así como la dirección IP del visitante y la cadena de agentes de usuario del navegador para ayudar a la detección de spam.<br/>
...
Texto sugerido: Si subes imágenes a la web, deberías evitar subir imágenes con datos de ubicación (GPS EXIF) incluidos. Los visitantes de la web pueden descargar y extraer cualquier dato de ubicación de las imágenes de la web.<br/>

<p className="text-2xl">Cookies</p>

Son aquellas cookies que son enviadas al ordenador o dispositivo del Usuario y gestionadas exclusivamente por y para el mejor funcionamiento del Sitio Web. La información que se recaba se emplea para mejorar la calidad del Sitio Web y su Contenido y su experiencia como Usuario. Estas cookies permiten reconocer al Usuario como visitante recurrente del Sitio Web y adaptar el contenido para ofrecerle contenidos que se ajusten a sus preferencias.<br/>

<p className="text-2xl">Cookies de terceros</p>
...
Esta página web utiliza Google Analytics, un servicio analítico de web prestado por Google, Inc., una compañía de Delaware cuya oficina principal está en 1600 Amphitheatre Parkway, Mountain View (California), CA 94043, Estados Unidos (“Google”).<br/>

Google Analytics utiliza “cookies”, que son archivos de texto ubicados en su ordenador, para ayudar al website a analizar el uso que hacen los usuarios del sitio web. La información que genera la cookie acerca de su uso del website (incluyendo su dirección IP) será directamente transmitida y archivad a por Google en los servidores de Estados Unidos.<br/>

Google usará esta información por cuenta nuest ra con el propósito de seguir la pista de su uso del website, recopilando informes de la actividad del webs ite y prestando otros servicios relacionados con la actividad del website y el uso de Internet.<br/>

Google podrá transmitir dicha información a terceros cuando así se lo requiera la legislación, o cuando dichos terceros proces en la información por cuenta de Google. Google no asociará su dirección IP con ningún otro dato del que disponga Google.<br/>

Puede Usted rechazar el tratamiento de los datos o la información rechazando el uso de cookies mediante la selección de la conf iguración apropiada de su navegador, sin embargo, debe Usted saber que si lo hace puede ser que no pueda usar la plena funcionabilidad de este website. Al utilizar este website Usted consiente el tratamiento de información acerca de Usted por Google en la forma y para los fines arriba indicados.<br/>
...
<p className=" flex flex-col gap-5">
<p className="text-2xl overflow-x-hidden">Cookies de redes sociales</p>
...
<li className="">   Facebook: <a href="https://www.facebook.com/policies/cookies/" className="text-green-500">https://www.facebook.com/policies/cookies/</a></li>
<li className="">   Twitter:  <a href="https://twitter.com/es/privacy" className="text-green-500">https://twitter.com/es/privacy</a></li>
<li className="">  Instagram: <a href="https://help.instagram.com/1896641480634370?ref=ig" className="text-green-500">https://help.instagram.com/1896641480634370?ref=ig</a></li>
<li className="">   YouTube: <a href=" https://policies.google.com/technologies/cookies" className="text-green-500"> https://policies.google.com/technologies/cookies</a></li>
<li className="">  Pinterest:  <a href="https://www.facebook.com/policies/cookies/" className="text-green-500">https://policy.pinterest.com/privacy-policy</a></li>
<li className="">  LinkedIn: <a href="https://www.linkedin.com/legal/cookie-policy?trk=hp-cookies" className="text-green-500">https://www.linkedin.com/legal/cookie-policy?trk=hp-cookies</a></li>
...
Texto sugerido: Si dejas un comentario en nuestro sitio puedes elegir guardar tu nombre, dirección de correo electrónico y web en cookies. Esto es para tu comodidad, para que no tengas que volver a rellenar tus datos cuando dejes otro comentario. Estas cookies tendrán una duración de un año.<br/>
...
Si editas o publicas un artículo se guardará una cookie adicional en tu navegador. Esta cookie no incluye datos personales y simplemente indica el ID del artículo que acabas de editar. Caduca después de 1 día.<br/>

<p className="text-2xl">EXCLUSIÓN DE GARANTÍAS Y DE RESPONSABILIDAD</p>
...
c) El incumplimiento de las leyes, la buena fe, el orden público, los usos del tráfico y el presente aviso legal como consecuen cia del uso incorrecto del sitio web. En particular, y a modo ejemplificativo, EL PROPIETARIO DE LA WEB no se hace responsable de las actuaciones de terceros que vulneren derechos de propiedad intelectual e industrial, secretos empresariales, derechos al honor, a la intimidad personal y familiar y a la propia imagen, así como la normativa en materia de competencia desleal y publicidad ilícita.<br/>
...
<p className="text-2xl">PROCEDIMIENTO EN CASO DE REALIZACIÓN DE ACTIVIDADES DE CARÁCTER ILÍCITO </p>
En el caso de que cualquier usuario o un tercero considere que existen hechos o circunstancias que revelen el car ácter ilícito de la utilizació n de cualquier contenido y/o de la realización de cualqui er actividad en las página s web incluidas o accesibles a través del sitio web, deberá enviar una notificación a EL PROPIETARIO DE LA WEB identificándose debidamente, especifica ndo las supuestas infracciones y declarando expresamente y bajo su responsabilidad que la información proporcionada en la notificación es exacta.<br/>

Para toda cuestión litigiosa que incumba al sitio web de EL PROPIETARIO DE LA WEB, será de aplicación la legislación, siendo competentes los Juzgados y Tribunales.

<p className="text-2xl">Contenido incrustado de otros sitios web </p>
Texto sugerido: Los artículos de este sitio pueden incluir contenido incrustado (por ejemplo, vídeos, imágenes, artículos, etc.). El contenido incrustado de otras webs se comporta exactamente de la misma manera que si el visitante hubiera visitado la otra web.<br/>
...
<p className="text-2xl">Con quién compartimos tus datos</p>
Texto sugerido: Si solicitas un restablecimiento de contraseña, tu dirección IP será incluida en el correo electrónico de restablecimiento.<br/>

<p className="text-2xl">Cuánto tiempo conservamos tus datos </p>
Texto sugerido: Si dejas un comentario, el comentario y sus metadatos se conservan indefinidamente. Esto es para que podamos reconocer y aprobar comentarios sucesivos automáticamente, en lugar de mantenerlos en una cola de moderación.<br/>

De los usuarios que se registran en nuestra web (si los hay), también almacenamos la información personal que proporcionan en su perfil de usuario. Todos los usuarios pueden ver, editar o eliminar su información personal en cualquier momento (excepto que no pueden cambiar su nombre de usuario). Los administradores de la web también pueden ver y editar esa información.<br/>

<p className="text-2xl">Qué derechos tienes sobre tus datos </p>
...
<p className="text-2xl">Embedded content from other websites </p>
...
<p className="text-3xl">Who we share your data with</p>
<p className="text-3xl">How long we retain your data</p>
...
<p className="text-2xl">What rights you have over your data</p>
If you have an account on this site, or have left comments, you can request to receive an exported file of the personal data we hold about you, including any data you have provided to us. You can also request that we erase any personal data we hold about you. This does not include any data we are obliged to keep for administrative, legal, or security purposes.<br/>

<p className="text-2xl">Dónde se envían tus datos </p>
Texto sugerido: Los comentarios de los visitantes puede que los revise un servicio de detección automática de spam.<br/>

<p className="text-2xl">Where we send your data </p>
Visitor comments may be checked through an automated spam detection service.<br/>

<p className="text-2xl">Your contact information </p>
<p className="text-2xl">Additional information </p>
<p className="text-2xl">How we protect your data </p>
<p className="text-2xl">What data breach procedures we have in place </p>
<p className="text-2xl">What third parties we receive data from</p>
<p className="text-2xl">What automated decision making and/or profiling we do with user data </p>
<p className="text-2xl">Industry regulatory disclosure requirements </p>
</p>

<div className="flex gap-5 flex-col justify-evenly lg:flex-row">
<div className="text-green-500 italics text-xl font-bold flex items-center justify-center">Earth Powered Space</div>
